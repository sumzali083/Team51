...
export const Signup = () => {
    return (
        <div>
            ...
            <p className='font-light text-lg'>We are glad to see you back with us!</p>
            </div>
            <form>
                <div className='flex items-center space-x-1 bg-gray-200 rounded-lg p-2'>
                    <CiUser className='text-xl'/>
                    <input className='bg-transparent w-full outline-none' type="text" placeholder='Username'/>
                </div>
                <div className='my-4 flex items-center space-x-1 bg-gray-200 rounded-lg p-2'>
                    <RiLockPasswordLine className='text-xl'/>
                    <input className='bg-transparent w-full outline-none' type="password" placeholder='Password'/>
                </div>
