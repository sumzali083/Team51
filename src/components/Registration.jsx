...
import OSAI from '../assets/OSAI.png'
    ...
    return (
        <div className='px-4 max-w-7xl mx-auto space-x-20 flex justify-center items-center h-screen'>
            ...
            <div className='pb-4 text-sm flex items-center justify-between'>
                ...
                <button onClick={() => setIsLogin(!isLogin)}className='font-semibold underlined'>{isLogin ? 'Sign up' : 'Login' }</button>
            </div>
            ...
            <div className='w-1/2 hidden lg:block'>
                <img className='rounded-2xl' src={OSAI}alt=''/>
            </div>
        </div>
    )
}